...
The work to accomplish this was already done by various others (see below link), but I did not find a single
convenient dependency that ties all that work together, so that's all this repo is.
